...
- [5.10 - Define derterminations](#510---define-determinations)
- [5.11 - Implement the determinations using Joule](#511---implement-the-determination-using-joule-)
- [5.12 - Define validations](#512---define-validations)
- [5.13 - Implement the validations using Joule](#513---implement-the-validations-using-joule-)
- [5.14 - Preview and test the enhanced online shop app](#514---preview-and-test-the-enhanced-online-shop-app)
- [Summary](#summary)
...
I
## 5.11 - Implement the determination using Joule 💎
...
## 5.14 - Preview and Test the enhanced Online Shop App
